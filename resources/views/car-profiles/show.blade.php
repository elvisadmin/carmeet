                            ...
                            <div class="space-y-3">
                                ...
                                @endif
                                 @if ($carProfile->facebook)
                                    <div class="flex border-b border-gray-200 dark:border-gray-600 pb-2">
                                        <span class="font-medium w-24 text-gray-600 dark:text-gray-400">Facebook:</span>
                                        <span class="text-gray-800 dark:text-gray-200">{{ $carProfile->facebook }}</span>
                                    </div>
                                @endif
                                  @if ($carProfile->instagram)
                                    <div class="flex border-b border-gray-200 dark:border-gray-600 pb-2">
                                        <span class="font-medium w-24 text-gray-600 dark:text-gray-400">Instagram:</span>
                                        <span class="text-gray-800 dark:text-gray-200">{{ $carProfile->instagram }}</span>
                                    </div>
                                @endif
                                    @if ($carProfile->tiktok)
                                    <div class="flex border-b border-gray-200 dark:border-gray-600 pb-2">
                                        <span class="font-medium w-24 text-gray-600 dark:text-gray-400">Tiktok:</span>
                                        <span class="text-gray-800 dark:text-gray-200">{{ $carProfile->tiktok }}</span>
                                    </div>
                                @endif
                                @if ($carProfile->twitter)
                                    <div class="flex border-b border-gray-200 dark:border-gray-600 pb-2">
                                        <span class="font-medium w-24 text-gray-600 dark:text-gray-400">X(Twitter):</span>
                                        <span class="text-gray-800 dark:text-gray-200">{{ $carProfile->twitter }}</span>
                                    </div>
                                @endif
                                @if ($carProfile->mod_tags)
                                    <div class="flex border-b border-gray-200 dark:border-gray-600 pb-2">
                                        <span class="font-medium w-24 text-gray-600 dark:text-gray-400">Mod Tags:</span>
                                        <span class="text-gray-800 dark:text-gray-200">{{ $carProfile->mod_tags }}</span>
                                    </div>
                                @endif
                            </div>
                        </div>
